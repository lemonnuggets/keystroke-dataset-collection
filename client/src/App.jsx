...
const App = () => {
  ...
  return (
    <div>
      ...
      {sectionNo === 2 && <Test1 goNextSection={incrementSectionNo} user={user} makeRequest={makeRequest}/>} {/* .tie5Roanl */}
      {sectionNo === 3 && <Test2 goNextSection={incrementSectionNo} user={user} makeRequest={makeRequest}/>} {/* Quotes */}
      {/*
